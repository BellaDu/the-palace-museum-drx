...
/*define behavior*/
function change() {
  document.getElementById('hisp1').innerHTML = `The Palace Museum houses over 180,000 pieces 
  ...
  document.getElementById('hisi1').src = './images/history/his4.jpeg';
}
...
function back() {
  ...
  document.getElementById('hisi1').src = './images/history/his7.jpeg';
}
